    ...
    <section className="relative py-20 bg-gradient-to-br from-[#04649b] to-[#03527d] text-white">
      <div className="section-container text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto">
          Market trends, investment tips, and island lifestyle insights to help you make the most of
          Roatan real estate.
        </p>
      </div>
    </section>
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h2
                  className="text-xl font-bold text-[#1d1d1d] mb-3 group-hover:text-[#04649b] transition-colors"
                  style={{ fontFamily: "'Roboto Slab', serif" }}
                >
                  {post.title}
                </h2>
                <p className="text-gray-600 leading-relaxed text-sm">{post.excerpt}</p>
                <span className="inline-block mt-4 text-sm font-medium text-[#04649b] group-hover:underline">
                  Read article →
                </span>
              </div>
            </Link>
