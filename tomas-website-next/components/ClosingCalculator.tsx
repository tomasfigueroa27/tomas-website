    ...
    <div className="space-y-5">
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <span className={`inline-block text-xs px-2 py-1 rounded-full font-medium ${structure === 'asset' ? 'bg-amber-100 text-amber-700' : 'bg-green-100 text-green-700'}`}>
...
export default function ClosingCalculator() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-8 max-w-2xl mx-auto">
      ...
      <p className="text-xs text-gray-400 mt-6">* Estimates only. Actual costs vary by transaction and legal counsel. Consult a licensed Honduran attorney for exact figures.</p>
    </div>
  );
}
